  ...
  return (
    ...
    >
      <div className="relative inset-0 p-4 rounded-2xl w-full h-full">
        {/* Title */}
        <h2
          className={`text-lg manrope-medium text-white group-hover:text-shadow-lg transition-all duration-300 ease-in-out ${expanded ? "" : "truncate group-hover:text-shadow-lg transition-all duration-300 ease-in-out"
            }`}
        >
          {agent.name}
        </h2>
        ...
        {/* Tags */}
        <div
          className={`flex gap-2 mt-2 ${expanded ? "flex-wrap" : "overflow-hidden whitespace-nowrap"
        ...
        <div className="min-h-16">
          <p
            ref={descRef}
            className={`mt-2 text-sm text-gray-300 outfit-regular ${expanded ? "" : "line-clamp-3"
              }`}
          >
            {agent.description}
          </p>
        ...
        <div className={` ${isTruncated ? "mt-6" : "mt-6"}`}>
          <div
            className={`w-full rounded-xl ${agent.video_url === null
          ...
          >
            <div
              ...
              className={`group flex flex-row items-center justify-center w-full rounded-2xl py-2 text-sm outfit-medium ${agent.video_url === null
